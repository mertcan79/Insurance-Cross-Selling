...
"""
DAG to extract Insurance data, load into AWS S3, and copy to AWS Redshift
"""
...
with DAG(
    ...
    extract_data = BashOperator(
        ...
        bash_command = f"python /opt/airflow/extraction/extract_etl.py {output_name}",
        dag = dag,
    )
    extract_data.doc_md = 'Extract data and store as CSV'
    ...
    upload_to_s3.doc_md = 'Upload CSV data to S3 bucket'
